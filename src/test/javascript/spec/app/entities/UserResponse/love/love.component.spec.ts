...
import { LoveComponent } from 'app/entities/UserResponse/love/love.component';
...
describe('Component Tests', () => {
  describe('Love Management Component', () => {
    let comp: LoveComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LoveComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.loves[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
